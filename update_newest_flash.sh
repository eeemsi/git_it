...
create_alias() {
	...
	echo alias chromium=\"chromium --disk-cache-dir='/tmp' --incognito --ppapi-flash-path=/opt/libpepflashplayer.so --ppapi-flash-version="$downloaded_version"\" > "${HOME}/.zsh/chromium"
}
